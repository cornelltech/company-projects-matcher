...
def sort_and_match_by_pairs(projects, students, verbose = False):
	...
	projects.sort(key = lambda p: util.get_project_interest_from_rankings(p, students), reverse = True)
...
def do_tests():
	...
	projects_filtered = util.remove_infeasible_projects(students_lst, all_projects)
