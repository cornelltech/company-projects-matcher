...
def get_student_type_diversity_tup(fixed_output, first_name, second_name):
	'''
...
def is_type_diverse(fixed_output, first_name, second_name):
	...
	'''
	diversity_stats_output = get_student_type_diversity_tup(fixed_output, first_name, second_name)
...
def fix_singletons(fixed_teams, cleaned_teams, first_name, second_name):
	...
	if (len(lst) == 0):
		return cleaned_teams
	 	...
	 	stats = get_student_type_diversity_tup(fixed_teams, first_name, second_name)
	 	can_swap = stats[1]
